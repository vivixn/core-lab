...
// for(var i=0; i<1; i++){
// 	$('#foundpoem').append( "<div class='text2'>" + 
// 	foundText[1].text2.fullText + "<br>" + "<br>" +
// 		"</div>" )
// }

// for(var i=0; i<1; i++){
// 	$('#foundpoem').append( "<div class='text3'>" + 
// 	foundText[2].text3.fullText + "<br>" + "<br>" +
// 		"</div>" )
// }

// for(var i=0; i<1; i++){
// 	$('#foundpoem').append( "<div class='text4'>" + 
// 	foundText[i].searchByCategorization() + "<br>" + "<br>" +
// 		"</div>" )
// }